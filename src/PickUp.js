    ...
    return(
        <>
          ...
          <Row className="pickupsection">
            <Col md={8}>
    <h4>Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt, numquam autem. animi possimus, eum sapiente perspiciatis rerum cum cumque incidunt laudantium adipisci blanditiis. </h4>
        ...
        <Form>
              ...
              <Button variant="primary" type="submit" onClick={()=>getOTP(document.getElementById('number').value)} >
                Get OTP
              </Button>
              <Form.Group className="mb-3" controlId="formBasicEmail">
